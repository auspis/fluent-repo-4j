...
applyTo: 'src/main/java/**/*.java,src/test/java/**/*.java,src/**/*.sql,pom.xml,.github/workflows/*.yml,.github/workflows/*.yaml,README.md,data/wiki/**/*.md'
...
Code review constraints for this repository:
...
- Helper/Util conventions from repository instructions.

...
applyTo: 'src/main/java/**/*.java,src/test/java/**/*.java,src/**/*.sql,src/main/resources/**/*.yml,src/main/resources/**/*.yaml,src/main/resources/**/*.properties,.github/workflows/*.yml,.github/workflows/*.yaml,pom.xml'
...
Security focus for this repository:

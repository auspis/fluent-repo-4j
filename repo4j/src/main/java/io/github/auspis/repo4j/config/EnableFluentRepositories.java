package io.github.auspis.repo4j.config;
...
import io.github.auspis.repo4j.repository.FluentRepositoryFactoryBean;

/**
 * Annotation to enable Fluent SQL repository support.
 * Scans for interfaces extending Spring Data {@code Repository} and creates
 * proxy beans backed by {@link io.github.auspis.repo4j.repository.SimpleFluentRepository}.
 */
